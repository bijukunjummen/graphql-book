...
public class SampleDataService {
  ...
  public SampleDataLoadResult loadSampleData() {
    Author a1 =
        createAuthor(AuthorId.parse("37fac9c2-d25d-45b6-945e-2cfe2a5b835b"), "Frank Herbert");
    ...
    createBook(
        BookId.parse("8028d1eb-0aa3-46fb-aecd-699a5e96e007"), "Ender's Game", 200, List.of(a2));

    Author a3 =
        createAuthor(AuthorId.parse("18bcf1cb-d0c9-4a90-a53c-ba9041965672"), "Douglas Adams");
    createBook(
    ...
    Author a4 =
        createAuthor(AuthorId.parse("f47621b4-b1c3-4c06-acbc-65ed8e6f9c76"), "Mary Shelley");
    createBook(
        BookId.parse("5f95e080-87b2-4234-87e7-95bf774099aa"), "Frankenstein", 200, List.of(a4));

    Author a5 =
        createAuthor(AuthorId.parse("d4c96974-eec5-4221-a24a-e0996c88d9b2"), "Ray Bradbury");
    createBook(
        BookId.parse("08dd1eda-3e94-46c5-8eab-b43e755d5545"), "Fahrenheit 451", 200, List.of(a5));

    Author a6 =
        createAuthor(AuthorId.parse("d50657f5-5e00-4117-ab97-e6a45e33e444"), "George Orwell");
    ...
    Author a9 =
        createAuthor(AuthorId.parse("a3d7f148-0058-4fb5-8a85-a0e7e0a04130"), "Isaac Asimov");
    createBook(
        BookId.parse("a031c746-6a01-43d6-aa20-b35672d47255"), "Foundation", 200, List.of(a9));

    Author a10 = createAuthor(AuthorId.parse("075a9f48-6128-42dd-ab13-c1f45a2052d1"), "H.G. Wells");
    createBook(
        BookId.parse("0c94008c-efd0-483a-9e45-f5cde3df282b"),
        "The Time Machine",
        200,
        List.of(a10));

    Author a11 =
        createAuthor(AuthorId.parse("12c2d97c-4654-4398-bc0e-c40cf96715c6"), "Aldous Huxley");
    createBook(
        BookId.parse("c22ee984-7f74-4158-8bd5-79235b0ad051"), "Brave New World", 200, List.of(a11));

    Author a12 =
        createAuthor(AuthorId.parse("c6aa1cb3-c9bd-47e0-ba1f-12a35027df8d"), "Terry Pratchett");
    Author a13 =
        createAuthor(AuthorId.parse("38469694-b350-4f1a-89be-1c8fd9aeaf2d"), "Neil Gaiman");
    createBook(
        BookId.parse("2f5ac49b-af88-4e72-a549-5f86aff4e549"), "Good Omens", 490, List.of(a12, a13));
