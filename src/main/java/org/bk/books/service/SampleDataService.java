...
public class SampleDataService {
    ...
    public SampleDataLoadResult loadSampleData() {
        ...
        createBook(BookId.parse("7f33a782-b811-4da0-8a18-e997aac2ea05"), "The Hitchhiker's Guide To The Galaxy", 200, List.of(a3));
        ...
        createBook(BookId.parse("0418ca6a-6c1f-4faa-b793-48e41bd93cfc"), "Do Androids Dream of Electric Sheep", 200, List.of(a8));
