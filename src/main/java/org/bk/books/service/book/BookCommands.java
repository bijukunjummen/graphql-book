...
public interface BookCommands {
  ...
  record CreateOrUpdateBookCommand(
      BookId id, String name, int pageCount, List<AuthorId> authors, int version) {
    public CreateOrUpdateBookCommand(
        BookId id, String name, int pageCount, List<AuthorId> authors) {
  ...
  record UpdateBookAuthorsCommand(BookId id, List<AuthorId> authorIds, int version) {}
}
