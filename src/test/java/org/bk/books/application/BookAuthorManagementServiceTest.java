...
class BookAuthorManagementServiceTest {
    ...
    void test_getAuthorsForBooks_whenNoAuthorLinks_returnsEmptyListsAndSkipsAuthorFetch() {
        ...
        assertThat(result).containsEntry(firstBookId, List.of()).containsEntry(secondBookId, List.of());
    ...
    void test_getAuthorsForBooks_whenLinksPresent_returnsMappedAuthorsPerBook() {
        ...
        Author firstAuthor = Author.create(
                firstAuthorId,
                "George Orwell",
                TimeTestData.DEFAULT_CREATED_DATE,
                TimeTestData.DEFAULT_UPDATED_DATE,
                1);
        Author secondAuthor = Author.create(
                secondAuthorId,
                "Aldous Huxley",
                TimeTestData.DEFAULT_CREATED_DATE,
                TimeTestData.DEFAULT_UPDATED_DATE,
        ...
        verify(authorService).getAuthors(assertArg((ByIds<AuthorId> ids) -> assertThat(ids.ids())
    ...
    void test_getAuthorsForBooks_whenSomeAuthorIdsMissing_filtersUnknownAuthors() {
        ...
        Author knownAuthor = Author.create(
                knownAuthorId,
                "George Orwell",
                TimeTestData.DEFAULT_CREATED_DATE,
                TimeTestData.DEFAULT_UPDATED_DATE,
