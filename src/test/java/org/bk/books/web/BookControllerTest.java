...
class BookControllerTest {
  ...
  @BeforeEach
  void beforeEach() {
    webTestClient = WebTestClient.bindToServer().baseUrl(baseUrl + "/graphql").build();
  ...
  void test_findBookById_withExistingBook_returnsBook() {
    ...
    var a13 =
        authorService.createOrUpdateAuthor(
            new CreateOrUpdateAuthorCommand(
                AuthorId.parse("38469694-b350-4f1a-89be-1c8fd9aeaf2d"), "Neil Gaiman"));
  ...
  void test_createBook_withValidInput_returnsCreatedBook() {
    ...
    String authorId =
        authorMutationResponse.path("createAuthor.createdAuthor.id").entity(String.class).get();
