...
class PaginationControllerTest {
    ...
    void test_findAuthors_whenPageSizeChangesAfterEndCursor_returnsNextAuthorPage() {
        ...
        GraphQlTester.Response firstPage = graphQlTester.document(query)
            .variable("first", 2)
            .execute();
        ...
        GraphQlTester.Response secondPage = graphQlTester.document(query)
            .variable("first", 3)
    ...
    void test_findBooks_whenPageSizeChangesAfterEndCursor_returnsNextBookPage() {
        ...
        firstPage
            .path("findBooks.pageInfo.hasNextPage")
            .entity(Boolean.class)
            .isEqualTo(true);
        firstPage
